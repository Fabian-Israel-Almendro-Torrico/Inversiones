/* VISTA HELP (EXPERTO) */
/* APARTADO DONDE EL USUARIO PODRA VER UNA GUIA PARA LA VISTA INICIO (EXPERTO) */
...
/*
 Componente principal para la vista de HELP (EXPERTO).
*/
const Help: React.FC = () => {
  ...
  return (
    ...
    {/* Contenido de la vista HELP */}
      ...
      {/* GUIA PARA CORRIDAS - NUMERO AÑOS */}
